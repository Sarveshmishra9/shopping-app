              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-5 mt-2">
                    ...
                    <p className="px-2 sm:px-3 sm:py-1 border-gray-400 bg-slate-50">
                      {item.size}
                    </p>
                  </div>
                </div>
                <input
                  ...
                  className="border border-gray-200 text-center max-w-10 sm:max-w-20 px-1 sm:px-2 py-1"
                  type="number"
                  min={1}
                ...
                <img
                  ...
                  className="w-4 mt-2 mr-4 sm:w-5 cursor-pointer"
                  src={assets.bin_icon}
                  alt=""
                />
              </div>
